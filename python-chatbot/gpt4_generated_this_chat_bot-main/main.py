...
def chatbot():
    ...
    """
    knowledge_base: dict = load_knowledge_base('C:/Users/Vivek/Downloads/gpt4_generated_this_chat_bot-main/gpt4_generated_this_chat_bot-main/knowledge_base.json')
